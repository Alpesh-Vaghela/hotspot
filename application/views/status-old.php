        ...
        <div class="carousel slide">
            <div class="carousel-inner">
                <div class="item active">
                    ...
                    <div class="main home">
                        <div class="header">
                            <div class="linefi-badge">
                                <?php
                                if ($socialdata->photoURL) {
                                    echo '<img src="' . $socialdata->photoURL . '" alt="" class="img-responsive center-block" />';

                                } else {
                                    echo '<img src="/assets/img/R1.png" class="img-responsive center-block">';
                                }
                                ?>
                            </div>
                            <h1 style="color:#<?php echo $ad_name_color; ?>">
                                Merhaba <?php
                            ...
                            <h3 style="color:#<?php echo $ad_name_description_color; ?>">Ücretsiz internetin keyfini çıkartın.</h3>
                            <h4 style="color:#<?php echo $ad_name_description_color; ?>">Şuan <strong>"<?php echo $ssdid->ssdid; ?>"</strong> kablosuz ağına bağlısınız.</h4>
                            <div class="row">
                                <div class="col-lg-4 col-lg-offset-4">
                                    <form role="form">
                                        <div class="form-group">
                                            <div class="col-sm-12 col-xs-10 center-block">
                                                <a href="<?php echo $website; ?>" class="btn">
