...
<head>
	...
	<meta property="og:image" content="<?=($nasbilgi->og_image ? $nasbilgi->og_image : "http://app.linefi.com/modules/servers/linefimodule/lib/uploads/n4rnlvy8hr4k888cww.png")?>">
                ...
                <div class="item active">
                    ...
                    <div class="main home">
                        <div class="header">
                            ...
                            <h4 style="color:#<?php echo $ad_name_description_color; ?>">İnternete Bağlanmak için
                                yukarıdaki <i class="fa fa-bars"></i> butona tıklayınız.</h4>
                        </div>
                    </div>
                </div>
            </div>
                                    ...
                                    <form role="form">
                                        <div class="form-group">
                                            <div class="col-sm-12 col-xs-10 center-block">
                                                <a href="/hauth/login/Facebook?nasid=<?php echo $nasbilgi->id; ?>"
                                                   class="btn btn-facebook"><i class="fa fa-facebook"></i> | Facebookla
                                                    Giriş Yap</a>
                                            </div>
                                        </div>
                                    </form>
                ...
                <div class="item active">
                    ...
                    <div class="main">
                        <div class="header">
                            ...
                            <h3 style="color:#<?php echo $ad_name_description_color; ?>"><?php echo $ad_name_description; ?></h3>
                            <h4 style="color:#<?php echo $ad_name_description_color; ?>">Twitter hesabınızla internete
                                giriş yapınız.</h4>
                            ...
                            <div class="row">
                                <div class="col-lg-4 col-lg-offset-4">
                                    <form role="form">
                                        <div class="form-group">
                                            <div class="col-sm-12 col-xs-10 center-block">
                                                <a href="/hauth/login/Twitter?nasid=<?php echo $nasbilgi->id; ?>"
                ...
                <div class="item active">
                    ...
                    <div class="main">
                        <div class="header">
                            ...
                            <h3 style="color:#<?php echo $ad_name_description_color; ?>"><?php echo $ad_name_description; ?></h3>
                            <h4 style="color:#<?php echo $ad_name_description_color; ?>">Instagram hesabınızla internete
                                giriş yapınız.</h4>
                            ...
                            <div class="row">
                                <div class="col-lg-4 col-lg-offset-4">
                                    <form role="form">
                                        <div class="form-group">
                                            <div class="col-sm-12 col-xs-10 center-block">
                                                <a href="/hauth/login/Instagram?nasid=<?php echo $nasbilgi->id; ?>"
                        ...
                        <div class="header">
                            ...
                            <div class="row">
                                <div class="col-lg-4 col-lg-offset-4 ">
                                    ...
                                    <form role="form" action="<?php echo $_POST['action']; ?>"
                                          method="post">
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-sm-12 col-xs-10 center-block">
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-12 col-xs-10 center-block">
                                                ...
                                                <input name="accept" type="submit" class="btn btn-default" value="Log In">
                                            </div>
                                        </div>
                                    </form>
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-sm-12 col-xs-10 center-block">
                                                    ...
                                                    <input type="text" name="kimlik_ad" class="form-control" id="" placeholder="Adınız">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-sm-12 col-xs-10 center-block">
                                                    <input type="text" name="kimlik_soyad" class="form-control" id="" placeholder="Soyadınız">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-sm-12 col-xs-10 center-block">
                                                    <input type="text" name="kimlik_cepno" class="form-control" id="" placeholder="Telefon Numaranız">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                ...
                <div class="item active">
                    ...
                    <div class="main">
                        <div class="header">
                            ...
                            <h3 style="color:#<?php echo $ad_name_description_color; ?>"><?php echo $ad_name_description; ?></h3>
                            <h4 style="color:#<?php echo $ad_name_description_color; ?>">Lütfen aşağıdaki formu nüfus
                                cüzdanınızdaki gibi doldurunuz. <br>Eğer kimlik bilgileriniz onaylanırsa internete
                                otomatik bağlanacaksınız.</h4>
