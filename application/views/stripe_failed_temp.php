...
<title>Stripe Payment Failed</title>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <p>Your Payment Has Been Failed For Following Reason: <span style="color: rgb(188, 26, 26);"><?php echo $this->session->flashdata('striperror'); ?></span> </p>
        </div>
        <div class="modal-footer">
          <a href="/welcome/getlokasyon/3598l5ef" class="btn btn-primary">Return</a>
        </div>
      </div>
